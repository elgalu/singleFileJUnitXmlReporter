(function() {
     ...
     * @param {string} xsltApplyPath path to an xslt file that should be applied after reporting is done
     */
    var singleFileJUnitXmlReporter = function(savePath, consolidate, useDotNotation, xsltApplyPath) {
        this.baseSavePath = (savePath || 'default');
        this.savePath = this.baseSavePath + '.xml';
        this.consolidate = consolidate === jasmine.undefined ? true : consolidate;
        this.useDotNotation = useDotNotation === jasmine.undefined ? true : useDotNotation;
        this.xsltApplyPath = xsltApplyPath;
        this.writeFile(this.savePath, '<?xml version="1.0" encoding="UTF-8" ?>' + "\n<testsuites>");
    };
    singleFileJUnitXmlReporter.started_at = null; // will be updated when test runner start
    singleFileJUnitXmlReporter.finished_at = null; // will be updated after all files have been written

    singleFileJUnitXmlReporter.prototype = {
        reportRunnerStarting: function() {
            // When run test, make it known on singleFileJUnitXmlReporter
            singleFileJUnitXmlReporter.started_at = (new Date()).getTime();
        },
    ...
    // export public
    jasmine.singleFileJUnitXmlReporter = singleFileJUnitXmlReporter;
})();
